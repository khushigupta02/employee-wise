...
- Java Version 17+
- Build Tool Maven
- REST APIs JSON format requestresponse
...
1. ✅ PREREQUISITES
   - Java 17 or later
   - Apache Maven
   - CouchDB installed and running (http127.0.0.15984)
...
2. 📥 PROJECT SETUP
   ...
   - Configure the CouchDB properties in `application.properties`
    ```json
   spring.couchdb.url=httplocalhost5984
...
📍 BASE URL `httplocalhost8080apiemployees`
...
```json
{
  ...
  profileImage httpsexample.comimage.jpg
}
...
- Example 123e4567-e89b-12d3-a456-426614174000manager2
